...
def main():
    ...
    while True:
        ...
        if not game_over:
            ...
            if ship_y+40 > obstacle.top and ship.right > obstacle.left \
        ...
        #그림과 장애물 합치기
            ...
            print(obstacle.left,obstacle.top,ship_y, ship.right, )
        ...
        if game_over:
            ...
            restart_image = sysfont.render("Restart : Press R key", 
                                     True, (255, 0, 0))
